...
<script type="text/javascript" src="/static/uploadify-v3.1/jquery.uploadify-3.1.min.js"></script>
<link rel="stylesheet" type="text/css" href="/static/uploadify-v3.1/uploadify.css" />
            ...
            $("#file_upload").uploadify({
                ...
                'onUploadSuccess' : function(file, data, response) {
                    if(data){
                        var json = eval("(" + data + ")");
//                        if(json.message=='ok'){
//                            pic_paths.val(pic_paths.val()+','+json['url']);
//                            pic_ids.val(pic_ids.val()+','+json['time']);
//                            upload_pics_box.append('<div style="width:100px;float:left;margin:5px"><img src="http://gobiker1.b0.upaiyun.com'+json['url']+'_min.jpg"><div>');
//                        }
//                        else{
//                            alert('很抱歉，照片上传失败，原因：'+json.message);
//                        }
                        if(json.status==1){
                            pic_ids.val(pic_ids.val()+','+json['img_path']);
                            pic_paths.val(pic_paths.val()+','+json['img_path']);
                            upload_pics_box.append('<div style="width:100px;float:left;margin:5px"><img src="'+json['img_path']+'"><div>');
                        }
                        else{
                            alert('很抱歉，照片上传失败，原因：\n\n'+json.error);
                        }
