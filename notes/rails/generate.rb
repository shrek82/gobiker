...
rails generate migration AddImgToAttacheds img:string{100} img_file_name:string{50} img_content_type:string{20} img_file_size:integer img_updated_at:timestamp
=end
