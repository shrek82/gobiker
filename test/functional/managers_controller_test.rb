...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { email: @manager.email, login_at: @manager.login_at, name: @manager.name, password: @manager.password, role: @manager.role }
    end
  ...
  test "should update manager" do
    put :update, id: @manager, manager: { email: @manager.email, login_at: @manager.login_at, name: @manager.name, password: @manager.password, role: @manager.role }
    assert_redirected_to manager_path(assigns(:manager))
  end
