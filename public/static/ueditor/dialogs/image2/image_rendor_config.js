...
utils.domReady(function () {
    ...
    zuaaUeditorImage.flashOptions = {
        ...
        url: '/attacheds/upload',                                          // 上传处理页面的url地址
        ext: '{"_format":"json","_gobiker_session":"BAh7B0kiD3Nlc3Npb25faWQGOgZFRkkiJTFlYzcwYjZlOTI4YWUzMWVhNzU3MGI0MDYxNjYyZDUzBjsAVEkiEF9jc3JmX3Rva2VuBjsARkkiMUxCSERoenlMRU82eHkzZ2p6NFpjbDcycG5GWGtJYVlpR1h1clc0K3F3ODg9BjsARg==--b9f634997a6d26a018bfa48b85397ebf5226cafa","authenticity_token":"LBHDhzyLEO6xy3gjz4Zcl72pnFXkIaYiGXurW4+qw88="}',//可向服务器提交的自定义参数列表
        ...
        uploadDataFieldName: 'attached[img]',// POST请求中图片数据的key
        picDescFieldName: 'attached[name]',    // POST请求中图片描述的key
