define("dist/lib/src/lib", [ "gallery/jquery/1.8.2/jquery", "dist/lib/src/popup", "dist/lib/src/ajax_form" ], function(require, exports, module) {
    //引入jquery
    var jquery = require("gallery/jquery/1.8.2/jquery");
    window.$ = window.jQuery = jquery;
    //基础弹出窗
    var popup = require("dist/lib/src/popup");
    //引入常用插件
    require("dist/lib/src/ajax_form")($);
    //定义基本功能
    var lib = {};
    lib.popup = popup;
    module.exports = lib;
